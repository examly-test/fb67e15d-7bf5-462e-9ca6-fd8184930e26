...
(async () => {
  ...
  await page.goto('https://8080-aacdadadbbcfbbdbadfeecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-aacdadadbbcfbbdbadfeecdcaceefaffcabd.ide.exam.ly');
